...
def main():
    ...
    if phase is not Phases.FINE_TUNE:
        ...
        # Each of these three is a list of SceneData objects
        ...
        # Each of these is a ScenesDataSet object
        # an object that contains the list of SceneData objects (each contains M, Ps, ets)
        # and a __getitem__ method which either get the full data from
        # all the views or a random sample of it.
        ...
        # Create dataloaders
        # Each of these is a torch dataloader object that loads batches of the data from the corresponding ScenesDataSet object
