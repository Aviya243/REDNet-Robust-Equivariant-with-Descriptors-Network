...
class optTest:
    def __init__(self, conf = 'RESFM_Learning.conf', scan=None, exp_version=None, external_params=None, phase = None, pretrainedPath=None, resume=None, wandb=1):
        self.conf = conf
        self.scan = scan
...
def init_exp(default_phase):
    ...
    conf_path = "/home/projects/ronen/aviyashm/Projects/RESFM/resfm/code/confs/RESFM_Learning.conf"
    opt = optTest(conf_path, scan=None, exp_version=None, external_params=None, phase=default_phase, pretrainedPath=None, resume=None, wandb=0)
    import torch
