...
class EmbeddingLayer(Module):
    # Embedding layer with positional encoding using sin and cos functions
    # multires is the number of frequencies used in the positional encoding
    # in_dim is the dimension of the input features
    # if multires=0, no positional encoding is used
    # the output dimension is in_dim * (2 * multires + 1)
